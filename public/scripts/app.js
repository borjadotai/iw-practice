...
function retrieveAllCitiesData(cityList, date) {
  refreshCityList();
  for (index in cityList) loadCityData(cityList[index], date);
}
...
function addToResults(dataR) {
  if (document.getElementById("results") != null) {
    ...
    row.innerHTML =
      ...
      "<div class='row'>" +
      "<div class='col-xs-2'><h4 class='card-title'>" +
      dataR.location +
      "</h4></div>" +
      "<div class='col-xs-2'>" +
      getForecast(dataR.forecast) +
      "</div>" +
      "<div class='col-xs-2'>" +
      getTemperature(dataR) +
      "</div>" +
      "<div class='col-xs-2'>" +
      getPrecipitations(dataR) +
      "</div>" +
      "<div class='col-xs-2'>" +
      getWind(dataR) +
      "</div>" +
